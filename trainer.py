...
class Trainer(object):
    def __init__(self,
        ...
        self.global_step = tf.train.get_or_create_global_step(
            graph=None)  # TODO: deprecation warning switch to tf.train.get_or_create_global_step tf.contrib.framework.get_or_create_global_step
        ...
        self.supervisor = tf.train.Supervisor(
            # TODO: deprecation warning: Please switch to tf.train.MonitoredTrainingSession  tf.train.Supervisor
